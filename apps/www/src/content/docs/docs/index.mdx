...
Visit the [Getting Started](/docs/getting-started) guide for detailed setup instructions.
...
- [Core Concepts](/docs/core-concepts) — Understand spaces, files, and workspaces
