...
- Scoped to a workspace — each space belongs to one workspace
...
2. **Don't over-organize** — Semantic search makes files findable regardless of location
3. **Use descriptions** — Add descriptions to spaces so team members understand their purpose
4. **Leverage nesting** — Use `parentSpaceId` for natural hierarchies

## Next Steps

- [Uploading Files](/docs/features/uploading-files) — Add content to your spaces
- [AI Search](/docs/features/ai-search) — Find content across spaces
