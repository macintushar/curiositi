...
- `apps/documentation`: Astro Starlight static site generation (`astro build`).
...
- **Docs:** Output in `apps/documentation/dist` → deploy to any static host.

## Deployment Targets

| Target           | Notes                                                                                                                 |
| ---------------- | --------------------------------------------------------------------------------------------------------------------- |
| Vercel           | Excellent for `apps/web` + optionally `apps/documentation` (static export)                                           |
